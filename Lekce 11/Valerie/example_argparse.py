...
parser.add_argument("--files_dir", type=str, help="Path to desired json directory", default="more_data")
parser.add_argument("--keys_to_save", type=str, nargs="+")
...
def main() -> None:
    # files_dir = "more_data"
    # keys_to_save = ("index", "isActive")
    args = parser.parse_args()
    json_to_csv(args.files_dir, args.keys_to_save)
